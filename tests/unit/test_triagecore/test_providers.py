    ...
    with patch.dict(
        ...
        with patch("httpx.AsyncClient", return_value=mock_client):
            ...
            mock_client.put.assert_called_once_with(
                ...
                json={"command": "host-deny", "custom": False, "agents_list": ["agent-123"]},
    ...
    with patch.dict(
        ...
        with patch("httpx.AsyncClient", return_value=mock_client):
            ...
            mock_logger.critical.assert_called_once_with(
                "wazuh.ar.error", error="Connection Refused", alert=True, containment_failure=True
            )
...
async def test_thehive_provider_critical_logs(mock_logger):
    ...
    with patch.dict(os.environ, {"THEHIVE_URL": "http://thehive:9000", "THEHIVE_API_KEY": "test-api-key"}):
        mock_client = setup_mock_client()
        ...
        with patch("httpx.AsyncClient", return_value=mock_client):
            ...
            mock_logger.critical.assert_called_once_with(
                "thehive.create.error", error="HTTP 500", alert=True, case_mgmt_failure=True
            )
...
async def test_cortex_provider_critical_logs(mock_logger):
    ...
    with patch.dict(os.environ, {"CORTEX_URL": "http://localhost:9001", "CORTEX_API_KEY": "test-api-key"}):
        mock_client = setup_mock_client()
        ...
        with patch("httpx.AsyncClient", return_value=mock_client):
            ...
            mock_logger.critical.assert_any_call(
                "cortex.analysis.error", error="Analyzer Unavailable", alert=True, enrichment_failure=True
            )
