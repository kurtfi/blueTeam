...
DATABASE_URL = os.getenv("ATTACK_SIMULATOR_DATABASE_URL", settings.agentix_postgres_url.replace("+asyncpg", ""))

# Target Agentix Webhook URL
WEBHOOK_URL = os.getenv("AGENTIX_WEBHOOK_URL", "http://localhost:8080/v1/webhooks/simulation")

# Internal API Key for webhook authentication bypass
INTERNAL_API_KEY = os.getenv("AGENTIX_INTERNAL_API_KEY", settings.agentix_internal_api_key)
